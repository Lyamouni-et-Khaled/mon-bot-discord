...
COGS_TO_LOAD = [
    ...
    'cogs.moderator_cog',
    'cogs.giveaway_cog',
    'cogs.guild_cog'  # Assurez-vous que ce cog existe ou retirez-le de la liste
]
...
# Ce petit serveur web répond aux "health checks" de Google Cloud
# pour lui dire que le bot est bien en vie.
app = Flask('')
...
if __name__ == "__main__":
    ...
    # Cela permet au bot de répondre à Google tout en étant connecté à Discord.
